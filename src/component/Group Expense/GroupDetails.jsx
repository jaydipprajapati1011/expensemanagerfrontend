...
import InviteGroupModal from './InviteGroup'; // Import the InviteGroupModal component
...
const GroupDetails= () => {
    ...
    const fetchGroupDetails = async () => {
      try {
        const response = await axios.get(
          `http://localhost:4000/groups/group/${groupid}`
        );
  ...
  const handleLeaveGroup = async () => {
    try {
      await axios.post(`http://localhost:4000/groups/${groupid}/leave`, { userId });
