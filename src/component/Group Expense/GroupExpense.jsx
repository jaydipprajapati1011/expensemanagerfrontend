...
import { GroupExpTable } from './GroupExpTable';
import { useEffect } from 'react';
import { AddGroupExp } from './AddGroupExp';
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          'http://localhost:4000/groupexp/group/' + groupid
        );
            ...
            <div className="col-md-12">
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  {groupid && <GroupExpTable groupid={groupid} />}
                </div>
              </div>
            </div>
          </div>
